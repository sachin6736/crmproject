...
import { litigation, updateOrderStatus,createLitigation, updateLitigation, getLitigation,sendRMAForm,addProcurement, updateProcurement ,resolveLitigation, markAsRefund, markRefundCompleted, getRefundOrders,addLitigationNote,createReplacementOrder} from "../controllers/litireplace.js";
...
router.post('/create-replacement/:orderId', protect, createReplacementOrder);
